  ...
  return (
    <>
      ...
      <div className='block lg:hidden z-[-1] relative w-screen aspect-[1/1.5] -mt-[150%] overflow-hidden'>
        <Bg color={theme === 'light' ? '#52525b' : '#52525b'} className='origin-center opacity-50' />
      </div>
    ...
    >
      <g clipPath='url(#clip0_1225_5704)'>
        ...
        <path
          ...
          strokeMiterlimit='10'
        />
        <path d='M137.029 0.25H99.1992V38.08H137.029V0.25Z' stroke={color} strokeWidth={stroke} strokeMiterlimit='10' />
        <path d='M198.149 0.25H137.029V61.37H198.149V0.25Z' stroke={color} strokeWidth={stroke} strokeMiterlimit='10' />
        <path
